...
// END of moved fields
  ...
  protected Set // Record symbold used/defined in this subprogram.
...
//##25 END
  ...
  public Map
    fMultipleSetRef = null; //##70
      ...
      //   (seq (list refered-nodes) (list set-nodes) (list write-nodes)
      // where refered-nodes are subtree whose value is refered and not set,
      // set-nodes are subtree whose value is set,
      // write-nodes are subtree whose value is set and not refered.
      // These lists may contain the same node when it is refered and set.
