...
//====== Methods to correlate HIR with index & ExpId ======
    ...
    divideHirIntoBasicBlocks()
  {
    ...
    if ((lNodeCount > fNodeCountLim1)||
    	(fSymExpCount > fSymCountLim1))
      fComplexity = 2;
    if ((fBBlockCount > fBBlockCountLim1)||    //##100
        (fLabelDefCount > fLabelDefCountLim1)) //##100
      fComplexity = 2;                         //##100
    if ((lNodeCount > fNodeCountLim2)||
    	(fSymExpCount > fSymCountLim2))
      fComplexity = 3;
    //##100 BEGIN
    if ((fBBlockCount > fBBlockCountLim2)|| 
    	(fLabelDefCount > fLabelDefCountLim2))
      fComplexity = 3;
    if ((lNodeCount > fNodeCountLim3)||
    	(fSymExpCount > fSymCountLim3))
      fComplexity = 4;
    if ((fBBlockCount > fBBlockCountLim3)|| 
        (fLabelDefCount > fLabelDefCountLim3))
      fComplexity = 4;
    if ((lNodeCount > fNodeCountLim4)||
    	(fSymExpCount > fSymCountLim4))
      fComplexity = 5;
    if ((fBBlockCount > fBBlockCountLim4)|| 
        (fLabelDefCount > fLabelDefCountLim4))
      fComplexity = 5;
    //##100 END
    //##62 END
    if (fDbgLevel > 0) {
