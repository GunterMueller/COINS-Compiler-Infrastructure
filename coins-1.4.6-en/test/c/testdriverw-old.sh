...
# for x86-cygwin with gcc and cpp (neithergcc-3 nor cpp-3)
...
CLASS="coins.driver.Driver -S -b x86-cygwin -coins:preprocessor='cpp -I/usr/include'" # CoinsCC compiler default assembler=as
